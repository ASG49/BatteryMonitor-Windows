//=============================================================================
// BatteryMonitor.cs - Windows Battery Monitor v31.1
...
//
// Key Features v31.1:
//   - LR/avg/Run fonts unified at 13pt scaled; hint fonts ScaleFont; badge offsets use S() for DPI consistency
...
namespace BatteryMonitor
{
    ...
    public class DualAxisChartPanel : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
                    ...
                    if (lrPrediction.Length > 0)
                    {
                        ...
                        using (var brush = new SolidBrush(LRLineColor))
                        {
                            ...
                            if (RunTimeSeconds > 0)
                            {
                                ...
                                using (var timeFont = new Font("Segoe UI", ScaleFont(13f), FontStyle.Bold))
                ...
                if (avgClickState == 2)
                {
                    ...
                    if (avgResult.Length > 0)
                    {
                        ...
                        using (var brush = new SolidBrush(avgColor))
                        {
                            ...
                            float tx = pa.Left + (pa.Width - sz.Width) / 2;
                            float ty = pa.Top + S(30) + ScaleFont(13f) + S(8);
                            using (var bgBr = new SolidBrush(Color.FromArgb(210, 255, 255, 255)))
                                g.FillRectangle(bgBr, tx - 4, ty - 2, sz.Width + 8, sz.Height + 4);
            ...
            if (EnableLR && lrClickState < 2)
            {
                ...
                using (var font = new Font("Segoe UI", ScaleFont(12f)))
    ...
    public class MainForm : Form
    {
        ...
        {
            this.Text = "Battery Monitor v31.1";
        ...
        private void StartCsvRecording()
        {
            ...
            try
            {
                ...
                this.Text = "Battery Monitor v31.1  —  " + fn;
            }
            catch (Exception ex)
            {
        ...
        private void LoadCSVFile(string path)
        {
            try
            {
                ...
                this.Text = "Battery Monitor v31.1  —  " + shortName;
