//=============================================================================
// BatteryMonitor.cs - Windows Battery Monitor v31.0
...
//
// Key Features v31.0:
//   - Load CSV filename now correctly shown in window title bar (ParentForm was null — now uses this.Text directly)
...
namespace BatteryMonitor
{
    ...
    public class MainForm : Form
    {
        ...
        {
            this.Text = "Battery Monitor v31.0";
        ...
        private void StartCsvRecording()
        {
            ...
            try
            {
                ...
                this.Text = "Battery Monitor v31.0  —  " + fn;
            }
            catch (Exception ex)
            {
        ...
        private void LoadCSVFile(string path)
        {
            try
            {
                ...
                this.Text = "Battery Monitor v31.0  —  " + shortName;
