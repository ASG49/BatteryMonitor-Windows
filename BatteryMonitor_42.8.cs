//=============================================================================
// BatteryMonitor.cs - Windows Battery Monitor v42.8
...
//   v42.2 (May 27, 2025): T(BMS) header removed; chart T curve reverted to TC66 temp; legend "Temp (TC66)"
...
namespace BatteryMonitor
{
    ...
    {
        private const string AppVersion = "v42.8";  // ← UPDATE ONLY HERE
        ...
        private void UpdateHeader(BatteryReading r)
        {
            ...
            // T(BMS) header display removed — WMI temp not reliable on Lenovo hardware
            lblBMSTemp.Visible = false;
        }
