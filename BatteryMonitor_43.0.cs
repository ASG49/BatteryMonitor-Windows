//=============================================================================
// BatteryMonitor.cs - Windows Battery Monitor v43.0
...
//   v43.0 (May 27, 2025): Legend/axis labels: parentheses → ", unit" style; TC66 temp "Temp(TC),°C"
...
//   v42.2 (May 27, 2025): T(BMS) header removed; chart T curve reverted to TC66 temp; legend "Temp(TC),°C"
...
namespace BatteryMonitor
{
    ...
    public class BatteryReader
    {
            ...
            try
            {
                using (var s = new ManagementObjectSearcher("root\\WMI",
                    ...
                    foreach (ManagementObject o in s.Get())
                    {
                        ...
                        if (dr != null) { double d = Convert.ToDouble(dr); if (d > 0) cachedDirectPower_mW = d; }
                        else if (cr != null) { double c = Convert.ToDouble(cr); if (c > 0) cachedDirectPower_mW = c; }
        ...
        private double GetBatteryTemperatureFromWMI()
        {
            try
            {
                // Take the first valid thermal zone — on Yoga 7 this is TZ01
                // No instance name filtering: just validate the temperature range
                using (var searcher = new ManagementObjectSearcher("root\\WMI",
                    "SELECT CurrentTemperature FROM MSAcpi_ThermalZoneTemperature"))
                {
                    foreach (ManagementObject obj in searcher.Get())
                    {
                        ...
                        if (currentTemp != null)
                        {
                            ...
                            double tempC = (Convert.ToDouble(currentTemp) - 2732.0) / 10.0;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (yData2.Count > 0)
            {
                ...
                if (yDataTemp.Count > 0)
                {
                    ...
                    {
                        string txt = "T=" + tempVal.ToString("F1") + " °C";
            ...
            double y2Min, double y2Span)
        {
            using (var font = new Font("Segoe UI", ScaleFont(17f), FontStyle.Regular, GraphicsUnit.Pixel))
            {
                ...
                if (xDataTC66_2.Count > 0)
                {
                    ...
                    entries.Add(new LegendEntry(y2Legend, tc66y2Col, 0.5f, true));
                }
                ...
                if (xDataTC66_1.Count > 0)
                {
                    ...
                    entries.Add(new LegendEntry(y1Legend, tc66y1Col, 0.5f, true));
                }
                ...
                // TC66 Temperature
                if (xDataTemp.Count > 0)
                    entries.Add(new LegendEntry("Temp(TC),°C", TempColor, 0.5f, true));
    ...
    {
        private const string AppVersion = "v43.0";  // ← UPDATE ONLY HERE
        ...
        private void BuildUI()
        {
            ...
            lblHealth     = MakeHeaderLabel("H=--%",         Color.FromArgb(0, 100, 60));
            ...
            float[] colPct = new float[] {
                ...
                12f,  // 7: Qt/η    "η=68.5% 35°C"
                9f,   // 8: Et/BMStemp "T=43°C"
                12f,  // 9: SOC/ETA
                9f,   // 10: H=/Cyc= "H=97.2%"
            };
            ...
            chartVI = new DualAxisChartPanel
            {
                ...
                Y1Title = "Volt,V", Y1Unit = "V",
                Y2Title = "Curr,A", Y2Unit = "A",
        ...
        private Label MakeHeaderLabel(string text, Color color, int fontSize = 16)
        {
            ...
            return new Label
            {
                ...
                AutoSize = true,
                Margin = new Padding(0, S(4), S(8), 0),
        ...
        private void UpdateEfficiency()
        {
            ...
            if (lastTC66Reading != null && lastTC66Reading.IsValid)
            {
                lblBMSTemp.Text    = "Ttc=" + lastTC66Reading.Temperature_C + "°C";
        ...
        private void UpdateHeader(BatteryReading r)
        {
            ...
            {
                lblHealth.Text = "H=" + r.HealthPercent.ToString("F1") + "%";
