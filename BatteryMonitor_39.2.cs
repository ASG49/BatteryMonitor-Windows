//=============================================================================
// BatteryMonitor.cs - Windows Battery Monitor v39.2
...
namespace BatteryMonitor
{
    ...
    {
        private const string AppVersion = "v39.2";  // ← UPDATE ONLY HERE
        ...
        private void BuildUI()
        {
            ...
            float[] colPct = new float[] {
                ...
                12f,  // 6: Ec/Ein  "Ein=999.99 Wh"
                10f,  // 7: Qt/η    "Qt=99.99 Ah"
                12f,  // 8: Et/T=   "Et=999.99 Wh"
                17f,  // 9: SOC/ETA "SOC=100.0 %" / "ETA: ~22h 59m"
            };
            ...
            headerTbl.Controls.Add(lblTC66Temp,       8, 1);
        ...
        private void UpdateEfficiency()
        {
            ...
            if (einWh > 0.01 && ecWh > 0.01)  // Need at least 10mWh on both sides (~36s at 40W)
            {
        ...
        private void ClearAutoLR()
        {
            ...
            lblAutoETA.Visible = false;
            // Collapse row 1 if TC66 is also disconnected
            if (!tc66Reader.IsConnected)
            {
                headerTbl.RowStyles[1] = new RowStyle(SizeType.Absolute, 0);
                headerTbl.Height = S(44);
