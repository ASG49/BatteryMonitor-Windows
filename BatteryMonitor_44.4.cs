//=============================================================================
// BatteryMonitor.cs - Windows Battery Monitor v44.4
...
namespace BatteryMonitor
{
    ...
    public class DualAxisChartPanel : Panel
    {
            ...
            double y2Min, double y2Span)
        {
            using (var font = new Font("Segoe UI", ScaleFont(17f), FontStyle.Regular, GraphicsUnit.Pixel))
            {
                ...
                // Legend order: SOC first, then Power, then energy/cap, then BMS temp
    ...
    {
        private const string AppVersion = "v44.4";  // ← UPDATE ONLY HERE
        ...
        private void BuildUI()
        {
            ...
            headerTbl.Controls.Add(lblBMSTemp,    8, 1);  // BMS temp — col 8 row 1 (TC66Temp slot)
            ...
            if (!double.IsNaN(lastAutoSOC) && (lastAutoSOC - soc) > 0)
            {
                ...
                if (autoLRTimes.Count >= 3)
                {
                    ...
                    if (etaSeconds > 0)
                    {
                        ...
                        string etaStr = (reliable ? "ETA: " : "ETA: ~") +
                                        (hh > 0 ? hh + "h " : "") + mm + "m";
